Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
				   ...
				   Modified by Christopher Shireman from original version to allow for custom arrow
                   DESC
  ...
  s.platform     = :ios, '6.0'
  s.source       = { :git => "https://github.com/cshireman/PDTSimpleCalendar.git", :tag => s.version.to_s }
